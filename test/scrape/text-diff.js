...
describe('Text Diffing', function () {
  describe('#cleanTree', function () {
    [
      ...
      {
        name: 'Collapse runs of newlines',
        input: `Hello 
  ...
  describe('#diffText', function () {
    [
      ...
      { name: 'Same string', prev: 'Hello world', curr: 'Hello world', expected: [] },
      {
        ...
        prev: 'Five. Six.',
        curr: 'Four. Five. Six.',
        expected: [{ pre: '', prior: '', current: 'Four.', post: 'Five.' }],
      },
      {
        name: 'Add in middle',
        prev: 'Four. Six.',
        curr: 'Four. Five. Six.',
        expected: [{ pre: 'Four.', prior: '', current: 'Five.', post: 'Six.' }],
      },
      {
        name: 'Add at end',
        prev: 'Five. Six.',
        curr: 'Five. Six. Seven.',
        expected: [{ pre: 'Six.', prior: '', current: 'Seven.', post: '' }],
      },
      {
        name: 'Remove at front',
        prev: 'Four. Five. Six.',
        curr: 'Five. Six.',
        expected: [{ pre: '', prior: 'Four.', current: '', post: 'Five.' }],
      },
      {
        name: 'Remove in middle',
        prev: 'Four. Five. Six.',
        curr: 'Four. Six.',
        expected: [{ pre: 'Four.', prior: 'Five.', current: '', post: 'Six.' }],
      },
      {
        name: 'Remove at end',
        prev: 'Five. Six.',
        curr: 'Five.',
        expected: [{ pre: 'Five.', prior: 'Six.', current: '', post: '' }],
      },
      {
        name: 'Change at front',
        prev: 'Four. Five. Six.',
        curr: 'Three. Five. Six.',
        expected: [{ pre: '', prior: 'Four.', current: 'Three.', post: 'Five.' }],
      },
      {
        name: 'Change in middle',
        prev: 'Four. Five. Six.',
        curr: 'Four. Five and half. Six.',
        expected: [{ pre: 'Four.', prior: 'Five.', current: 'Five and half.', post: 'Six.' }],
      },
      {
        name: 'Change at end',
        prev: 'Four. Five. Six.',
        curr: 'Four. Five. Seven.',
        expected: [{ pre: 'Five.', prior: 'Six.', current: 'Seven.', post: '' }],
      },
      {
        name: 'Two additions',
