...
describe.only('Html Scraper', function () {
    ...
    describe('#compareVersions', function () {
        it('should return diffs with context', function () {
            ...
            assert.deepEqual(diffs, [
                ...
                },
                {
                    ...
                    "post": "Any individual registering to vote must send the completed application\nwith his/her original signature to the county'sBoard of Registrars\n[http://sos.",
        ...
        it('should return links to pdfs', function () {
            const newHtml = textOfFile('alabama-sos-min-2.html');
            const oldHtml = textOfFile('alabama-sos-min-1.html');
            const { pdfs } = scraper.compareVersions('http://example.com/', newHtml, oldHtml)
            assert.deepEqual(pdfs, [
                'http://example.com/sites/default/files/voter-pdfs/nvra-2.pdf',
                'http://example.com/sites/default/files/voter-pdfs/Domestic_Violence_Affidavit.pdf'
